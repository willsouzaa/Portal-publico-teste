...
export default function WhatsappButton() {
  return (
    <a
      ...
      className="fixed z-50 bottom-6 right-6 w-16 h-16 rounded-full bg-[#25D366] hover:bg-[#20b64d] shadow-lg flex items-center justify-center text-white transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-green-300 border-2 border-white"
